...
#define STRING_CONFIG_H_AUTHOR "(DuhncanG)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "TONY"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -45, -12, -1.68 }
